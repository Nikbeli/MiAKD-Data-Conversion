...
namespace ConvertData
{
    public partial class Main : Form
    {
        ...
        private void Main_Load(object sender, EventArgs e)
        {
            ...
            comboBox_Date.Items.Add("ToLongDateString");
            comboBox_Date.Items.Add("ToShortDateString");
            comboBox_Date.Items.Add("ToLongTimeString");
            comboBox_Date.Items.Add("ToShortTimeString");
